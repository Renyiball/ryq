...
return array(
		...
		//IMG
		"ThinkImage" => LIBRARY_PATH.'ORG/Util/Image/ThinkImage.class.php',
	    //文件操作类 Dir
		...
		"ThinkOauth"=>LIB_PATH.'Extend/ThinkSDK/ThinkOauth.class.php',
	
		//标签库
		"TagLibSpadmin"=>LIB_PATH.'Taglib/TagLibSpadmin.class.php',
		"TagLibHome"=>LIB_PATH.'Taglib/TagLibHome.class.php',
		//Hook
